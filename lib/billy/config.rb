...
module Billy
  class Config
    ...
    attr_accessor :logger, :cache, :cache_request_headers, :whitelist, :cache_whitelist, :path_blacklist, :ignore_params, :allow_params,
                  ...
                  :before_handle_request, :cuprite_options, :match_requests_on,
                  :ignore_keys_in_body_for_generating_cache_key, :previous_ignore_keys_in_body_for_generating_cache_key
    ...
    def reset
      ...
      @previous_ignore_keys_in_body_for_generating_cache_key = []
      @match_requests_on = nil
